...
var featuredimagezoomer = {
    loadinggif: '../../Design/images/indicator.gif', //full path or URL to "loading" gif
    ...
    showimage: function($, $img, $mag, showstatus) {
        ...
        specs.$statusdiv.html('Zoom Actual: ' + specs.curpower + '<div style="font-size:80%">Use el Scroll del Mouse para Acercar/Alejar</div>')
    ...
    magnifyimage: function($img, e, zoomrange) {
        ...
        specs.$statusdiv.html('Zoom Actual: ' + specs.curpower)
